...
module file {
    ...
    /**搜索文件/目录 */
    function _search(path_s_: string, match_: RegExp, config_: file.search_config, result_ss_: string[]): string[] {
    ...
    /*---------function_public */
    /**搜索文件/目录 */
    export function search(root_s_: string, match_: RegExp, config_ = new file.search_config): string[] {
